...
const TermsAndConditions = () => {
  return (
    <Box shadow="md" borderWidth="1px" padding="32px" gap="8px">
      <Heading as="h4" variant="h4" color="black.75">
        Terms and Conditions
      </Heading>
      <br />
      <Box fontSize="14px">
        <Text as="p">Welcome to Otaku Emporium!</Text>
        <br />
        <Text as="p">
          These terms and conditions outline the rules and regulations for the
          use of Otaku Emporium's Website, located at www.otakuemporium.net.
        </Text>
        <br />
        <Text as="p">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Otaku Emporium if you do not agree
      ...
      <Box fontSize="14px">
        ...
        <Text as="p">
          We employ the use of cookies. By accessing Otaku Emporium, you agreed
          to use cookies in agreement with the Otaku Emporium's Privacy Policy.
      ...
      <Box fontSize="14px">
        ...
        <Text as="p">
          Unless otherwise stated, Otaku Emporium and/or its licensors own the
          intellectual property rights for all material on Otaku Emporium. All
          intellectual property rights are reserved. You may access this from
          Otaku Emporium for your own personal use subjected to restrictions set
        ...
        <Text as="p">
          You must not:
          <OrderedList>
            <ListItem>Republish material from Otaku Emporium</ListItem>
            <ListItem>
              Sell, rent or sub-license material from Otaku Emporium
            </ListItem>
            <ListItem>
              Reproduce, duplicate or copy material from Otaku Emporium
            </ListItem>
            <ListItem>Redistribute content from Otaku Emporium</ListItem>
          </OrderedList>
          <br />
        ...
        <Text as="p">
          ...
          Otaku Emporium does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Otaku Emporium,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Otaku Emporium
        ...
        <br />
        <Text as="p">
          Otaku Emporium reserves the right to monitor all Comments and to
        ...
        <Text as="p">
          ...
          <br />
          You hereby grant Otaku Emporium a non-exclusive license to use,
      ...
      <Box fontSize="14px">
        ...
        <Text as="p">
          ...
          the hyperlink compensates the absence of Otaku Emporium; and (d) the
        ...
        <Text as="p">
          ...
          sending an e-mail to Otaku Emporium. Please include your name, your
          ...
          <br />
          No use of Otaku Emporium's logo or other artwork will be allowed for
      ...
      <Box fontSize="14px">
        ...
        <Text as="p">Please read Privacy Policy</Text>
        <br />
